 ...
 *   (0,0)
 */
#define X_NOZZLE_TO_PROBE_OFFSET 10  // X offset: -left  +right  [of the nozzle]
#define Y_NOZZLE_TO_PROBE_OFFSET 10  // Y offset: -front +behind [the nozzle]
#define Z_NOZZLE_TO_PROBE_OFFSET 10   // Z offset: -below +above  [the nozzle]
